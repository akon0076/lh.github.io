...
根据应用程序或页面类型的类型，某些模式可能比其他模式更合适。下表比较了不同模式的亮点并提供了每种模式的场景。

<img src="/img/patterns/2.35.png" loading=lazy>

[2022 年构建 JavaScript 网站的模式](https://dev.to/this-is-learning/patterns-for-building-javascript-websites-in-2022-5a93)，
